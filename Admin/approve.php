...
<div id="main">
  ...
  <span style="color: #10375c;font-size:30px;cursor:pointer" onclick="openNav()">&#9776; open</span>
	...
	function openNav() {
	  ...
	  document.body.style.backgroundColor = "rgba(186,232,232,1)";
	}
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
       ...
       <input type="text" name="tm" class="form-control" placeholder="Return Date Sep 09,2021 10:29:00" required="">


        <button style="background-color:#bae8e8;" class="btn btn-default" type="submit" name="submit">Approve</button>
    </form>
