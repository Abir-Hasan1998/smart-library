...
<div class="container">
	...
	<?php
		...
		?>
		<form method="post">
        <button type="submit" name="submit1" style="background-color: #101010ed; color: red; font-weight: 700; font-size: 18px;" class="btn btn-default"><span style="color: red" class="glyphicon-remove-sign"></span>&nbsp Remove</button>

        <button type="submit" name="submit2" style="background-color: #101010ed; color: green;" class="btn btn-default"><span style="color: green; font-weight: 700;font-size: 18px;" class="glyphicon-ok-sign"></span>&nbsp Approve</button>
        </form>
		<?php
